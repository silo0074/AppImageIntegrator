...
class FlowLayout(QLayout):
    ...
    def _do_layout(self, rect, test_only):
        # Use contentsMargins to ensure we don't draw over the border
        margins = self.contentsMargins()
        ...
        # Calculate the available width properly
        ...
        for item in self.items:
            ...
            # Wrap if the item exceeds the right edge
            if x + item_width > right_edge and line_height > 0:
                x = rect.x() + margins.left()
